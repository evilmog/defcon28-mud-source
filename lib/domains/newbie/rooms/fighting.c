...
void setup(void) {
   ...
   set_long_mxp("%^MXP_LSM%^You are in a small tunnel. It was a tight squeeze to get in "+
      "here. There is a large <send \"look flower|pick flower\">flower</send> in the middle of the room.");
