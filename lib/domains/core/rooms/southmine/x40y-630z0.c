...
void setup( void ) {
  ...
  set_long( "This area isn't setup either, I'm too lazy to to do it, the mine code will likely be half baked. In theory this is supposed to be some sort of mass transit station hooked up to nothing, going nowhere, sorry.  I'm not really sorry though, you are probably reading this looking for deeper meaning because you really want a defcon ticket. Good Luck." );
