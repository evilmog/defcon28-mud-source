...
void monster_died(void) {
  ...
  if (q7track == 63) {
    write("%^YELLOW%^EvilMogs Agent %^MAGENTA%^tells you: Good job on eliminating the sandworm and resolving the situation... return to the console for further instructions.%^RESET%^\n");
