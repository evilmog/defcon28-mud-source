...
void setup( void ) {
  ...
  add_item("wall", "The eastern wall looks suspiciously false, as if it's not made to be solid enough to be a wall. Perhaps you can try pushing it to find out more about its qualities.");
 set_exits( ([
  "southwest" : DIR+"/rooms/sewer/x-10y20z-20.c"
  ]) );
 set_hidden_exits( ([
  "push wall" : DIR+"/rooms/sewer/x10y30z-20.c"
  ]) );
}
