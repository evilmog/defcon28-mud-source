...
parser.add_argument('--custom', help='customization file', required=True)
...
parser.add_argument('--inherit', help='path to additional inherit', required=False)

parser.add_argument('--action1func', help='function for add_action() 1', required=False)
parser.add_argument('--action1', help='action for add_action() 1', required=False)
parser.add_argument('--action2func', help='function for add_action() 2', required=False)
parser.add_argument('--action2', help='action for add_action() 2', required=False)
parser.add_argument('--action3func', help='function for add_action() 3', required=False)
parser.add_argument('--action3', help='action for add_action() 3', required=False)

parser.add_argument('--hr', help='set to 1 to enable advancement functions', required=False)
...
if args.inherit:
    roomfile.write('inherit "' + args.inherit + '";\n')
if args.custom:
  roomfile.write('inherit "/domains/sci-fi/lib/' + args.custom + '";\n')
...
if args.hr:
    ...
    roomfile.write('  add_action("do_quest", "claim");\n')
    roomfile.write('  add_action("do_quests", "quests");\n')
    roomfile.write('  add_item("sign", do_hrsign());\n')
    roomfile.write('  add_action("do_recast", "recast");\n\n')
if args.action1:
    if args.action1func:
        roomfile.write('  add_action("' + args.action1func + '", "' + args.action1 + '");\n\n')
if args.action2:
    if args.action2func:
        roomfile.write('  add_action("' + args.action2func + '", "' + args.action2 + '");\n\n')
if args.action1:
    if args.action3func:
        roomfile.write('  add_action("' + args.action3func + '", "' + args.action3 + '");\n\n')
if args.doorlocked:
...
roomfile.write('\n  set_short(do_short());\n')
roomfile.write('  set_long(do_long());\n\n')
